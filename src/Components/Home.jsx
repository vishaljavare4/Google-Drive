...
import Logoo from "../assets/logo.png";  // Corrected path
...
<div className="w-screen h-screen overflow-hidden font-geist">
 <div className="flex items-center justify-between py-2 md:px-8">
   ...
   <button id='hovocolo' className="bg-blue-500 inline-flex items-center justify-center whitespace-nowrap rounded-md transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50  px-4 py-2 w-32 h-12 mr-2 text-lg font-medium  hover:bg-blue-600">
     Log In
   </button>
 </div>
 <div className="h-[calc(100vh-4rem)] flex items-center">
   <div className="flex flex-col gap-8 p-16 md:gap-12 md:w-1/2">
     ...
     <button className="inline-flex items-center justify-center whitespace-nowrap rounded-md transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-gray-300  px-4 py-2 w-32 h-12 mr-2 text-lg font-medium bg-blue-500 hover:bg-blue-600">
       Log In
     </button>
   </div>
